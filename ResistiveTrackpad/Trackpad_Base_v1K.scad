...
difference(){
      ...
      union() {
        ...
        //standoffs
        back(38) left(38) color("gold") cylinder(d=7, h=7+bottomThickness);
        back(38) right(38) color("gold")cylinder(d=7, h=7+bottomThickness);
        forward(38) left(38) color("gold")cylinder(d=7, h=7+bottomThickness);
        forward(38) right(38) color("gold")cylinder(d=7, h=7+bottomThickness);
        //snaptabs
